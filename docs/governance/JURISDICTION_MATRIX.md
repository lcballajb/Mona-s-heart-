...
No market is authorized by this document. Before launch, Product supplies user location, entity, hosting, payments, minors, providers, marketing, biometrics, research, and data-flow facts. Legal records scope; Privacy performs DPIA/transfer analysis; Security maps controls; Clinical/Regulatory assesses intended use; executive approver signs a launch gate.

| Region                           | Status  | Blocking evidence                                                                         | Recheck                 |
| -------------------------------- | ------- | ----------------------------------------------------------------------------------------- | ----------------------- |
| United States—each launch state  | Blocked | Counsel applicability memo, state matrix, notices, incident obligations, vendor contracts | Before any real data    |
